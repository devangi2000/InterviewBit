...
// Given a Binary Tree A containing N nodes, return all diagonal elements in a binary tree
...
// 6 and 7 belong to same diagonal i.e diagonal 2 but as 7 comes before 6 in pre-order
//  traversal so 7 will be added to answer array first.
